...
const DropdownBox: React.FC<DropdownBoxProps> = ({ subtitle, children, openOnInit }) => {
...
return (
    <div className="w-full">
      ...
      >
        ...
        {isOpen && (
          <div className="p-4 border-t border-gray-200 select-none">{/* game content unselectable */}
            {children}
          </div>
        )}
      </div>
